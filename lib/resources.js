 ...
 */
function Resource (client, id, objValues, dialogId) {
  var self = this;
  self._client = client;


  //if objValues is a string its definitely the dialogId
 ...
 */
function Application (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Asterisk (client, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, undefined, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Bridge (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Channel (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function DeviceState (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Endpoint (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function LiveRecording (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Mailbox (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Playback (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function Sound (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
 ...
 *  @param {Object} objValues - ownProperties to copy to the instance
 */
function StoredRecording (client, id, objValues, dialogId) {
  var self = this;
  Resource.call(self, client, id, objValues, dialogId);
}
    ...
    function callSwagger (/* args..., callback */) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        if (self._client._proxy) {
          ...
          self._client._proxy.send(self._dialogId, info.path, info.method, options, processResponse, swaggerError);
          return;
        }
        ...
        function processResponse (response) {
          ...
          if (result instanceof Object) {
            result.proxyDialogId = self._dialogId;
          }
 ...
 */
module.exports.Application = function (client, id, objValues, dialogId) {
  var application = new Application(client, id, objValues, dialogId);
 ...
 */
module.exports.Asterisk = function (client, objValues, dialogId) {
  var asterisk = new Asterisk(client, objValues, dialogId);
 ...
 */
module.exports.Bridge = function (client, id, objValues, dialogId) {
  console.log(objValues, dialogId);
  var bridge = new Bridge(client, id, objValues, dialogId);
 ...
 */
module.exports.Channel = function (client, id, objValues, dialogId) {
  var channel = new Channel(client, id, objValues, dialogId);
 ...
 */
module.exports.DeviceState = function (client, id, objValues, dialogId) {
  var deviceState = new DeviceState(client, id, objValues, dialogId);
 ...
 */
module.exports.Endpoint = function (client, id, objValues, dialogId) {
  var endpoint = new Endpoint(client, id, objValues, dialogId);
 ...
 */
module.exports.LiveRecording = function (client, id, objValues, dialogId) {
  var liveRecording = new LiveRecording(client, id, objValues, dialogId);
 ...
 */
module.exports.Mailbox = function (client, id, objValues, dialogId) {
  var mailbox = new Mailbox(client, id, objValues, dialogId);
 ...
 */
module.exports.Playback = function (client, id, objValues, dialogId) {
  var playback = new Playback(client, id, objValues, dialogId);
 ...
 */
module.exports.Sound = function (client, id, objValues, dialogId) {
  var sound = new Sound(client, id, objValues, dialogId);
 ...
 */
module.exports.StoredRecording = function (client, id, objValues, dialogId) {
  var storedRecording = new StoredRecording(client, id, objValues, dialogId);
